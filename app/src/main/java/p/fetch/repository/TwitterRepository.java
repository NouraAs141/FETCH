...
import p.fetch.models.Oauth2Token;
import p.fetch.models.Tweet;
import p.fetch.models.TweetStatuses;
import p.fetch.network.DateDeserializer;
import p.fetch.network.TwitterApi;
